...
# Policy: https://github.com/VinitaSilaparasetty/pr-automation-agent/blob/main/compliance/HUMAN_OVERSIGHT_POLICY.md
"""
...
def _welcome() -> None:
    ...
    click.echo()
    click.echo("  " + click.style("https://aevoxis.de", fg="cyan", underline=True)
               + "   — Aevoxis Solutions")
